    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                ...
                height: detailRectangle.width/10.5
                width: height
            }
            ...
            Text {
                id: solarMonthYear
                color: "#227c04"
                font.pixelSize: detailRectangle.width/16
            ...
            Text {
                ...
                font.pixelSize: detailRectangle.width/19
                color: "#f20707"
            ...
            Image {
                id: firstNumberImage
                width: detailRectangle.width/5.5
                height: width*1.6
        ...
        Text {
            id: day1
            color: "#093e9b"
            font.pixelSize: detailRectangle.width/28
            text: qsTr("Ngày")
